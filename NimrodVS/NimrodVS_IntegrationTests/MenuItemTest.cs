...
namespace NimrodVS_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Company.NimrodVS.GuidList.guidNimrodVSCmdSet, (int)Company.NimrodVS.PkgCmdIDList.cmdidInsertSnippet);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "NimrodVS", "Company.NimrodVS.NimrodVSPackage");
