...
using Company.NimrodVS;

namespace NimrodVS_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new NimrodVSPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.NimrodVS.GuidList.guidNimrodVSCmdSet, (int)Company.NimrodVS.PkgCmdIDList.cmdidInsertSnippet);
